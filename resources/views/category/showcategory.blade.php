		...
		<div class="container" id="catehere">
			...
			<div class="row">
				...
				<div id="store" class="col-md-9">
					...
					<div class="row">
						@foreach($cate_by_id as $key => $pro3)
						<!-- product -->
						<div class="col-md-4 col-xs-6">
							<div class="product">
								...
								<div class="add-to-cart">
									<button type="submit" class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i><a href="{{URL::to('/detail/'.$pro3->product_id)}}"> add to cart</a></button>
								</div>
							</div>
						</div>
						@endforeach
					...
					<!-- store bottom filter -->
					{{ $cate_by_id->links('pagination::bootstrap-4', ['prev_text' => '', 'next_text' => '']) }}
					<!-- /store bottom filter -->
